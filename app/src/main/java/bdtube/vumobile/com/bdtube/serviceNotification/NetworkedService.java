                ...
                try {
                    ...
                    for (int i = 0; i < contacts.length(); i++) {
                        ...
                        if (sample_url != null) {
                            ...
                            Utils.setCustomViewNotification(getApplicationContext(), replaceAllurl,StickerTitle, Push_Message, sample_url, i, contentCode, categoryCode, sContentType, sPhysicalFileName, ZedID, artist);
                            // SendLaunchPushRes();
